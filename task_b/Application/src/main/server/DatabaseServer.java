...
public class DatabaseServer extends UnicastRemoteObject implements Database {
    ...
    public DatabaseServer(Connection connection) throws RemoteException {
        super();
    ...
    @Override
    public Singer getSingerById(int id) throws RemoteException {
    ...
    @Override
    public boolean addCollection(Collection collection) throws RemoteException {
    ...
    @Override
    public Integer addSinger(Singer singer) throws RemoteException {
        String sql;
    ...
    @Override
    public boolean deleteSingerById(int id) throws RemoteException {
        String sql = "DELETE FROM singer " +
                "WHERE id = " + id;
        return execUpdateDelete(sql);
    }
    ...
    @Override
    public Integer addAlbum(int singerId, Album album) throws RemoteException {
        String sql;
        if (album.getId() != null) {
    ...
    @Override
    public boolean deleteAlbumById(int id) throws RemoteException {
    ...
    @Override
    public boolean updateSinger(Singer singer) throws RemoteException {
    ...
    @Override
    public Integer countAlbumsOfSingerById(int id) throws RemoteException {
    ...
    @Override
    public Collection getAll() throws RemoteException {
    ...
    @Override
    public Collection getAlbumsOfSingerById(int id) throws RemoteException {
    ...
    @Override
    public Collection getAllSingers() throws RemoteException {
